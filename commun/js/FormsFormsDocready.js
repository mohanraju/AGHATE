$(document).ready(function() {
	...
	$('input[type="text"]').blur(function() {
		...
		var pagevariables="FormUpdate_VID="+$('#VID').val()+"&FormUpdate_ID="+idF+"&FormUpdate_REF="+$('#ref').val()+"&FormUpdate_Var="+nameObj+"&FormUpdate_Libelle="+$(this).parent().children()[0].innerHTML+"&FormUpdate_Val="+data+"&Source="+DataSource+"&FormUpdate_Nip="+$('#nip').val()+"&FormUpdate_Nda="+nda+"&FormUpdate_Nohjo="+$('#nohjo').val()+"&FormUpdate_Entry="+entry+"&FormUpdate_End="+end+"&FormUpdate_Uhdem="+$('#uhdem').val()+"&FormUpdate_Uhexec="+$('#uhexec').val()+"&FormUpdate_Libuhdem=&FormUpdate_TypeAttribut="+TypeAttribut+"&FormUpdate_Username="+$('#Username').val()+"&FormUpdate_SaveDateTime="+$('#SaveDateTime').val()+"&FormUpdate_Diag="+code+"&FormUpdate_Libdiag="+data+"&table_loc="+table_loc;
