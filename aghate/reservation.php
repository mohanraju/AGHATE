...
if($type_reservation=="Demande"){
	...
	if($UserInfo[0]['droit_demande']=='0'){
		echo "<h1>Vous n'avez pas les droits necessaires pour effectuer une demande</h1>";
		exit;
	}
	...
	if(strlen($id)>0)
	{
		...
		$AnnuleButton 	= '<input type="button" id="Annnuler" name="Annnuler" value="Annnuler" class="btn btn-warning" 
							onclick="AnnuleReservation(\''.$NomTableLoc.'\');"/>';
		$SaveButton 	= '<input type="button" id="Enregistrer" name="Enregistrer" value="Enregistrer" class="btn btn-success" 
...
<script type="text/javascript" src="./commun/ckeditor/ckeditor.js"  charset="<?php print $charset?>"></script>
</head>
<body style="">
		...
		<td>
			<table>
				<tr>
					<td>
						<div class="input-prepend input-append">
							...
							<?php Print $Html->InputTextBox("patient_rech",$patient_rech,10,10,$TextBoxAttr);?>
							<span class="add-on"><b>Patient</b> </span>
							<?php Print $Html->InputTextBox("patient",$patient,60,60,$PatientAttr);?>
							<?php Print $Html->InputHiddenBox("nda",$nda); ?>
						</div>
					</td>
				</tr>
				...
				<tr>
					<td>
						 <div class="input-prepend input-append">
							...
							print  $Html->InputSelect($ListRoom,"room_id",$room_id,"./commun/ajax/ajax_aghate_resa_autocomplet_service.php","class='input-medium' $Display $AttrRoom" );
				...
				<tr>
					<td>
					<div class="input-prepend input-append">
					<span class="add-on"><b>Protocole </b> </span>
						<?php 
				...
				<tr>
					<td colspan="2">
					<div class="input-prepend input-append">
						<span class="add-on"><b>Couleur</b>&nbsp;&nbsp;&nbsp;</span>
							<?php 
				...
				<tr>
					...
					<div class="input-prepend input-append">
						...
						<?php Print $Html->InputTextArea("description",$description,5,93);?>
					</div>	
					</td>
				</tr>				
				<tr>
					<td align="center">
						<div class="noprint">
							...
							print $Html->InputHiddenBox("de_source",$res['de_source'] );									
							?>
						</div>
					</td>
				</tr>
