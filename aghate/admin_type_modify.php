...
<!-- jQuery -->
	...
	<!-- MiniColors -->
	<script src="./commun/js/jquery.minicolors.js"></script>
	<link rel="stylesheet" href="./commun/style/jquery.minicolors.css">
    ...
    echo "</TR><TR>\n";
    echo "<TD>COLOR</TD>\n";
    echo "<TD><input type='text' id='wheel-demo' class='form-control demo' data-control='wheel' value='#ff99ee'>\n";
    echo "</TR>";
