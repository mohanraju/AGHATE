...
?>
<br /><input type='radio' name='automatic_mail' value='yes' id='label_3' <?php if (getSettingValue("automatic_mail")=='yes') echo "checked=\"checked\"";?> /> <label for='label_3'><?php echo get_vocab("mail_admin_on");
if (getSettingValue("automatic_mail") == 'yes') {
    echo " - <a href='admin_email_manager.php'>".get_vocab('admin_email_manager.php')."</a>\n";
}
?></label>
<br /><input type='radio' name='automatic_mail' value='no' id='label_4' <?php if (getSettingValue("automatic_mail")=='no') echo "checked=\"checked\"";?> /> <label for='label_4'><?php echo get_vocab("mail_admin_off"); ?></label>
<?php
// Configuration des liens adresses
echo "</p><hr /><h3>".get_vocab('configuration_liens_adresses')."</h3>\n";
echo "<p>";
?>
<input type='radio' name='envoyer_email_avec_formulaire' value='yes' id='label_5' <?php if (getSettingValue("envoyer_email_avec_formulaire")=='yes') echo "checked=\"checked\"";?> /> <label for='label_5'><?php echo get_vocab("envoyer_email_avec_formulaire_oui");
?></label>
...
if (getSettingValue('grr_mail_method')=="mail") echo " checked=\"checked\" ";
echo "/>\n";
echo get_vocab('methode mail');
echo "&nbsp;&nbsp;<input type=\"radio\" name=\"grr_mail_method\" value=\"smtp\" ";
if (getSettingValue('grr_mail_method')=="smtp") echo " checked=\"checked\" ";
echo "/>\n";
...
if (getSettingValue('grr_mail_Bcc')=="y") echo " checked=\"checked\" ";
echo "/>";
...
echo "\n<input type='radio' name='javascript_info_disabled' value='0' "; if (getSettingValue("javascript_info_disabled")=='0') echo "checked=\"checked\""; echo " />";
echo "\n</td></tr>";
echo "\n<tr><td>".get_vocab("javascript_info_disabled1")."</td><td>";
echo "\n<input type='radio' name='javascript_info_disabled' value='1' "; if (getSettingValue("javascript_info_disabled")=='1') echo "checked=\"checked\""; echo " />";
echo "\n</td></tr>";
echo "\n</table>";
