...
<?php
	...
	$tri_par=$_POST["tri_par"];
		...
		$sql_tri_par=" ORDER by agt_pat.nom, agt_loc.start_time,agt_loc.end_time		";
...
// Recherche des infos liée à la réservation
	$sql = "SELECT agt_pat.noip, 	nom, 	prenom ,	nomjf, 	ddn, 	sex,
			...
			FROM agt_room, agt_service, ".$Aghate->NomTableLoc."
			LEFT JOIN agt_pat ON ".$Aghate->NomTableLoc.".noip = agt_pat.noip								
