        ...
        if ($slot <= $last_slot)
        {
            ...
            if ($prev_weekday != $weekday)
            {
               ...
               // if (getSettingValue("display_info_bulle") == 1)
                ...
                $d[$weekday][$slot]["description"] = affichage_resa_planning($row[$i]['description'],$row[$i]['id']);
            ...
            and $_GET['pview'] != 1) {
                ...
                if ($enable_periods=='y') {
                    echo "<a href=\"edit_entry.php?room=$room&amp;area=$area"
                        ...
                        . "&amp;day=$wday&amp;page=week\" title=\"".get_vocab("cliquez_pour_effectuer_une_reservation")."\"><img src=\"./commun/images/new.png\" border=\"0\" alt=\"".get_vocab("add")."\" width=\"16\" height=\"16\"  class=\"print_image\"  />";
                    echo "</a>";
                } else {
                    echo "<a href=\"edit_entry.php?room=$room&amp;area=$area"
