...
$LESCHAMPS="NOIP as NIP,PAT.NMMAL as NOM,PAT.NMPMAL as PRENOM,to_char(PAT.DANAIS,'DD/MM/YYYY') as DANAIS,PAT.CDSEXM as SEXE,NOTLDO";

// 	si au moins 3 char de nom renseingn?
if(strlen($val_rech) > 2)

{
	$SQL=" SELECT $LESCHAMPS FROM PAT WHERE PAT.NMMAL LIKE('".$val_rech."%') OR PAT.NOIP LIKE('".$val_rech."%') AND INFUS='O' ORDER BY NMMAL,NMPMAL";	
