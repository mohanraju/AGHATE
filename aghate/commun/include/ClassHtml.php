...
Class Html extends MySQL
{
	...
	*/	
	...
	//=================================================
	//	function  InputTextArea : Divan le 20/05/14 
	// a revoir
	//=================================================
	function InputTextArea($VariableName,$default,$rows,$cols,$autres="")	{
			if($_SESSION["readonly"]=="true")
				$cache="readonly disabled";
			$res="";
			$res.="<textarea type=\"textarea\" name=\"$VariableName\" id=\"$VariableName\" class=\"form-control\" rows=\"$rows\" cols=\"$cols\" $autres $cache>$default</textarea>";
			return $res;
	}	
	//=================================================
